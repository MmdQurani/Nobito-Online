...
export function FooterAboutUs() {
  return (
    <div className='footer-About-us grid grid-cols-9'>
      ...
      <div className='footer-about-us-box flex-1 px-10 flex flex-col justify-around col-span-8' dir='rtl'>
        <h3 className='text-main-text-2 font-bold text-xl'>تلاش ما دسترسی آسان تر شما به خدمات پزشکی است</h3>

        <span className='text-sub-text text-sm leading-8'>
      ...
      <div className='footer-logo-box w-full flex justify-center items-center col-span-1'>
