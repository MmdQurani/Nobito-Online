          ...
          <nav className='w-full flex flex-row justify-between items-center' dir='rtl'>
            <div className='nav-right flex flex-row items-center'>
              ...
              <div className='navbar-btns h-full lg:flex flex-row gap-x-2 hidden ms-4'>
                <Link href='/' className='px-2.5 py-1 rounded-sm font-Dirooz font-normal text-sm hover:text-primery-600 text-sub-text'>نوبت دهی مطب</Link>
                <Link href='/' className='px-2.5 py-1 rounded-sm font-Dirooz font-normal text-sm hover:text-primery-600 text-sub-text'>خدمات</Link>
                <Link href='/' className='px-2.5 py-1 rounded-sm font-Dirooz font-normal text-sm hover:text-primery-600 text-sub-text'>مشاوره آنلاین</Link>
                <Link href='/' className='px-2.5 py-1 rounded-sm font-Dirooz font-normal text-sm hover:text-primery-600 text-sub-text'>مجله سلامت</Link>
                <Link href='/' className='px-2.5 py-1 rounded-sm font-Dirooz font-normal text-sm hover:text-primery-600 text-sub-text'>نیکوکاری</Link>
              </div>
